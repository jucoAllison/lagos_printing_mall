...
const Leftenvelopes = ({
  ...
  const onChangeForPremiumFinishing = (v, i) => {
    ...
    spreadGender[i].selected = !spreadGender[i].selected;

    setPremiumFinishing(spreadGender);
  };
    ...
    >
      ...
      <div className={Classes.manualCover}>
        <div className="flex gap-[20px] w-full items-top">
          <InputCom label={"Product"} readOnly={true} value={"Envelopes"} />
