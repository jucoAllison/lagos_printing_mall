...
const LeftBooks = ({
  ...
  const onChangeForOrientation = (v, i) => {
    const spreadGender = [...orientation];
    ...
    setOrientation(reMapped);
  };

  const mappOrientation = orientation.map((v, i) => (
    <div
      key={i}
      style={{
        backgroundColor: v.selected && "#eb268f",
      ...
      className={Classes.eachMapCover}
      onClick={() => onChangeForOrientation(v, i)}
    >
      {v?.name}
    </div>
  ));
    ...
    >
      ...
      <div className={Classes.manualCover}>
        <div className="flex gap-[20px] w-full items-top">
          <InputCom label={"Product"} readOnly={true} value={"Books"} />
        ...
        <div
          ...
          className={Classes.titleDataHere}
        >
          What type of book do you want to print?
        </div>
        ...
        <div className={Classes.wrapTheFlex}>{mappOrientation}</div>
        ...
        <div
          ...
          className={Classes.titleDataHere}
        >
          What cover material do you prefer?
        </div>
        ...
        <div
          ...
          className={Classes.titleDataHere}
        >
          What binding type do you prefer?
        </div>
