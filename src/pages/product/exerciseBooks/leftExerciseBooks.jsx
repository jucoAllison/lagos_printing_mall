    ...
    >
      ...
      <div className={Classes.manualCover}>
        <div className="flex gap-[20px] w-full items-top">
          <InputCom label={"Product"} readOnly={true} value={"Exercise book"} />
        ...
        <div
          ...
          className={Classes.titleDataHere}
        >
          What type of exercise book do you want to print?
        </div>
...
export default LeftExerciseBooks;
