...
import RightGreetingCard from "./rightCustomTshirts";
import LeftGreetingCard from "./leftCustomTshirts";
...
const CustomTShirt = () => {
  ...
  const [type, setType] = useState([
    ...
    { name: "Uniform/Staff Wear", selected: false },
    { name: "Promotion/Marketing", selected: false },
    { name: "Fashion Merch", selected: false },
    { name: "Personal Use", selected: false },
    { name: "Souvenir/Giveaway", selected: false },
  ]);
  ...
  const [orientation, setOrientation] = useState([
    { name: "Round Neck", selected: true },
    { name: "V-Neck", selected: false },
    { name: "Polo Shirt", selected: false },
    { name: "Long Sleeve", selected: false },
    { name: "Sleeveless", selected: false },
    { name: "Hoody", selected: false },
  ]);
  const [paperType, setPaperType] = useState([
    { name: "Front Center", selected: true },
    { name: "Front Left Chest", selected: false },
    { name: "Front Full Chest", selected: false },
    { name: "Back Center", selected: false },
    { name: "Back Full", selected: false },
    { name: "Multiple Locations", selected: false },
  ]);
  const [paperWeight, setPaperWeight] = useState([
    { name: "Screen Printing", selected: true },
    { name: "Heat Transfer (vinyl)", selected: false },
    { name: "DTF (Direct to Film)", selected: false },
    { name: "DTG (Direct to Garment)", selected: false },
    { name: "Sublimation (polyester only)", selected: false },
    { name: "Embroidery", selected: false },
  ]);
  ...
  const returnOrder = () => {
    const orderDetails = {
      ...
      details: [
        ...
        {
          type: "text",
          key: "What type of Tshirt do you want",
        ...
        {
          type: "text",
          key: "Where should the design be printed",
  ...
  const recheckError = () => {
    ...
    if (!inputs?.color) {
      toast.error("What color do you want? is required");
      return true;
    }
