  ...
  return (
    ...
    >
      ...
      <div className={Classes.manualCover}>
        ...
        <InputCom
          label={"What is the name of your brand/business?"}
          value={inputs?.name}
          placeholder={""}
          onChange={(e) => {
        ...
        <InputCom
          label={"What product(s) or service(s) do you offer?"}
          value={inputs?.offer}
          placeholder={""}
          onChange={(e) => {
            setInputs({ ...inputs, offer: e.target.value });
          }}
        />
        ...
        <Select
          label={"Do you need the design for"}
          statee={wantToPrint}
          setStatee={setWantToPrint}
        />
        <Select
          label={"What style of design do you prefer?"}
          setStatee={setSize}
          statee={size}
        />
...
{/* 
        ...
        <div className="flex items-center mt-7 ">
          <div
            ...
            className={Classes.titleDataHere}
          >
            Do you have: photos, logos, Product images, Brand symbols you want to use?
          </div>
...
export default LeftGraphicsDesign;
