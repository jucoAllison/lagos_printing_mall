...
import LeftMagazine from "./leftMagazine";
import RightMagazine from "./rightMagazine";
  ...
  const returnOrder = () => {
    const orderDetails = {
      ...
      details: [
        ...
        { type: "boolean", key: "Are there images, charts, or illustrations inside?", value: isImages },
        { type: "boolean", key: "Do you want eBook (digital) conversion alongside the print version?", value: eBook },
        { type: "boolean", key: "Do you need ISBN registration or barcode printing?", value: barcodePrinting },
        {
          type: "text",
          key: "Size",
...
...(schoolStationery
  ...
  const recheckError = () => {
    ...
    if (!inputs?.budget) {
      toast.error("What is your target budget for this print job?");
      return true;
    }

     if (!inputs?.totalPages) {
      toast.error("How many total pages does the book have is required");
      return true;
    }
