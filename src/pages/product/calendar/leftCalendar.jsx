    ...
    >
      ...
      <div className={Classes.manualCover}>
        <div className="flex gap-[20px] w-full items-top">
          <InputCom label={"Product"} readOnly={true} value={"Calender"} />
        ...
        <Select label={"Calendar Type"} setStatee={setPaperType} statee={paperType} />


        <Select label={"Lamination Type"} setStatee={setLamination} statee={lamination} />



        <Select label={"Number of pages"} setStatee={setPages} statee={pages} />



        <Select label={"Paper Type"} setStatee={setType} statee={type} />




        <Select label={"Printing"} setStatee={setPremiumFinishing} statee={premiumFinishing} />
        ...
        <Select label={"Paper Weight"} setStatee={setGsm} statee={gsm} />


        <Select label={"Binding Type"} setStatee={setPrintStyle} statee={printStyle} />
