    ...
    >
      ...
      <div className={Classes.manualCover}>
        <div className="flex gap-[20px] w-full items-top">
          <InputCom label={"Product"} readOnly={true} value={"Brochures"} />
        ...
        <InputCom
          ...
          onChange={(e) => {
            const newValue = e.target.value.replace(/\D/g, "");
            setInputs({ ...inputs, pages: newValue });
          }}
        />
        ...
        <Select label={"Paper Type"} setStatee={setPaperType} statee={paperType} />

        <Select label={"Lamination Type"} setStatee={setLamination} statee={lamination} />

        <Select label={"Folding Style"} setStatee={setPremiumFinishing} statee={premiumFinishing} />
